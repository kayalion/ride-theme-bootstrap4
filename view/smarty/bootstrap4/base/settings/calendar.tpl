...
{block name="head_title" prepend}{translate key="title.system.calendar"} | {/block}
...
{block name="content_title"}
    <nav class="breadcrumb">
        ...
        <a class="breadcrumb-item" href="{url id="system.calendar"}">
            {translate key="title.system.calendar"}
        </a>
    </nav>
