/**
 * This file has tweakes marked with @FIXME
 */
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var template = [
    ...
    "<select class='st-block-positioner__select selectized custom-select'></select>",
    "</div>"
  ].join("\n");
  ...
  Object.assign(SimpleBlock.prototype, __webpack_require__(187), __webpack_require__(60), __webpack_require__(188), __webpack_require__(192), {
    ...
    _setBlockInner : function() {
      ...
      this.$inner.bind('click mouseover', function(e){
        // @FIXME had to write over
        if (!$(e.target).is('.form-assets-add,.form-assets-done,.form-assets-remove,.fa-remove')) {
          e.stopPropagation();
        }
      });
    },
